...
{
#ifdef CONFIG_LORA_RFSW_VDD_GPIOX
    gpio_init(CONFIG_LORA_RFSW_VDD_GPIOX,
              CONFIG_LORA_RFSW_VDD_PIN,
              GPIO_MODE_OUTPUT_PP_HIGH);
#endif
}
...
void SX126xAntSwOff( void )
{
    ...
    gpio_init(CONFIG_LORA_RFSW_VDD_GPIOX,
              CONFIG_LORA_RFSW_VDD_PIN,
              GPIO_MODE_OUTPUT_PP_LOW);
#endif
}

void SX126xAntSwTx( void )
{
#ifdef CONFIG_LORA_RFSW_TR_GPIOX
#ifndef CONFIG_LORA_RFSW_TR_TX_LEVEL
#define CONFIG_LORA_RFSW_TR_TX_LEVEL    GPIO_MODE_OUTPUT_PP_LOW
#endif
    gpio_init(CONFIG_LORA_RFSW_TR_GPIOX,
              CONFIG_LORA_RFSW_TR_PIN,
              CONFIG_LORA_RFSW_TR_TX_LEVEL);
#endif
}
...
{
#ifdef CONFIG_LORA_RFSW_TR_GPIOX
#ifndef CONFIG_LORA_RFSW_TR_RX_LEVEL
#define CONFIG_LORA_RFSW_TR_RX_LEVEL    GPIO_MODE_OUTPUT_PP_HIGH
#endif
    gpio_init(CONFIG_LORA_RFSW_TR_GPIOX,
              CONFIG_LORA_RFSW_TR_PIN,
              CONFIG_LORA_RFSW_TR_RX_LEVEL);
#endif
}
